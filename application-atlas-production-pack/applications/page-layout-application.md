...
This is the same kind of product the market has historically called **desktop publishing** software. Vendors market one and the same product under both labels — the same application is titled "desktop publishing and page layout software," and its page-layout capability is documented on its own dedicated surface. This document describes the type under the modern functional label; the sibling document under the historical label (Desktop Publishing Application) covers the same referent.

Everything else the market associates with the category — master pages, style sheets, guides and baseline grids, fine-grained typography controls, layers, color separations, output checking and packaging — is standard structure that mature products add to make the core practical at professional scale.
...
Realized as:  linked-frame chains with automatic page insertion;
...
- **Consumer / small-business pole** — template-first authoring for cards, flyers, labels, newsletters, calendars; simplified controls; output is ordinary printing and PDF. This pole has been contracting as office suites and template galleries absorb its scenarios (the best-known office-bundled example has been announced for retirement).
...
|---|---|---|
| Desktop Publishing Application | same type under the historical label | vendors market one and the same product as both "desktop publishing" and "page layout" software; no structural difference |
...
| Document Editor / Word Processor | adjacent | word processor centers on a linear text stream with layout secondary; here the layout canvas is primary and text flows into placed frames. Note: some word processors offer a "page layout" document mode (a canvas of manually placed text boxes with manually added pages) — the frame-canvas model appears there, but as a secondary mode of a flowing-document application |
...
- **QuarkXPress** — the long-standing professional standard-bearer; marketed by its own vendor as both desktop publishing and page layout software, with a dedicated page-layout capability surface.
...
- Quark Software — QuarkXPress product page ("Desktop Publishing and Page Layout Software"): https://www.quark.com/products/quarkxpress
- Quark Software — QuarkXPress "Page Layouts" capability page: https://www.quark.com/page-layouts
...
- Apple — "Intro to word-processing and page layout documents in Pages on Mac" (Pages User Guide; used to disambiguate the term "page layout" as a document mode inside word processors): https://support.apple.com/guide/pages/word-processing-or-page-layout-tan6129a1862/mac
- Quark Software — QuarkXPress 2026 User Guide (chapters: Projects and Layouts; Text and Typography; Output), fetched 2026-09-07 and recorded in the paired Research Notes and in the sibling document's Research Notes: https://www.quark.com/documentation/quarkxpress/2026/english/A%20Guide%20to%20QuarkXPress%202026

> Sourcing limitation: the official documentation of Adobe InDesign (helpx.adobe.com, adobe.com) and Affinity Publisher (affinity.serif.com) could not be fetched from the research environment on 2026-09-08 (timeouts / browser-check block; the same surfaces were also unreachable on 2026-09-07). InDesign is evidenced here only through competitor-documented interchange behavior and general market position; Affinity Publisher is listed as market context without product-specific claims. Precise operational figures (page limits, maximum page sizes, default settings) observed in a single product's documentation were deliberately excluded from this document and remain in the paired Research Notes.

Detailed evidence, product-by-product observations, the cross-product comparison matrix, the alias joint review with the sibling document, and the historical/market-sample breadth check are recorded in the paired Research Notes.
