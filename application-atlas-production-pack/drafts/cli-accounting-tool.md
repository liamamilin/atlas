---
slug: cli-accounting-tool
name: CLI Accounting Tool
name_zh: 命令行记账工具
desc: 单机命令行复式记账工具（ledger/hledger/beancount 一类：纯文本账本、批处理报表、无 GUI）
link: https://ledger-cli.org
source: human
status: draft
engine: opencode
model: opencode-go/mimo-v2.5
created: 2026-09-12T19:20
---
# CLI Accounting Tool
