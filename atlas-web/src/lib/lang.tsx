...
export const T = {
  ...
  heroTitle: {
    zh: "1804 种软件应用类型，各有各的边界",
    en: "1,804 software application types, each with its own boundary",
  },
  ...
  appsP: {
    zh: "{n} 个真实软件产品，经 atlas 分类管线自动归位到 1804 类型中。每个产品卡片可跳转到它所属的类型页（含分界逻辑）。",
    en: "{n} real software products, automatically classified into the 1,804 atlas types. Each card links to its type page (with boundary logic).",
  },
  classified: { zh: "atlas 归类", en: "atlas classification" },
  unclassified: { zh: "未归类", en: "Unclassified" },
  footer: {
    zh: "Application Atlas · 1804 软件应用类型 · 由语料自动生成 · v1.1 方法论",
    en: "Application Atlas · 1,804 software application types · generated from the corpus · v1.1 methodology",
  },
  headerNote: { zh: "1804 类型 · 数据来自 atlas 语料", en: "1,804 types · data from the atlas corpus" },
